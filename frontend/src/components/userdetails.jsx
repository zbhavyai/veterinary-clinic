        ...
        return <React.Fragment>
            <div class="card" style={this.styles}>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                    < input type="text" id="inputFilter" className="form-control" placeholder="Status" aria-label="Status" aria-describedby="basic-addon2" />
                    </div>

                   

                    <a href="#" class="btn btn-primary">Save</a><a href="#" class="btn btn-primary">Remove</a><a href="#" class="btn btn-primary">Cancel</a>
                </div>
            </div>
